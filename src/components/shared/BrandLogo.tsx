...
// WhatsApp — single-path Simple Icons mark filled with brand green. Kept here
// so the Channels at-a-glance row can carry colored chips even though the
// editor's input adornments stay monochrome.
...
// Facebook — single-path mark filled with brand blue.
